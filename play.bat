...
:noApplication
java -XX:MaxPermSize=768M -Dsbt.ivy.home="%~dp0repository" -Dplay.home="%~dp0framework" -Dsbt.boot.properties="%fp%framework/sbt/play.boot.properties" -Dsbt.scala.version="%SBT_SCALA_VERSION%" %PLAY_OPTS% -jar "%~dp0framework\sbt\sbt-launch.jar" %*
